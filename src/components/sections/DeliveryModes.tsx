  ...
  return (
    <section id="delivery-modes" className="py-16 md:py-24 px-4 md:px-6 bg-[#F8FDFF] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-[1026px] mx-auto">
          ...
          >
            <div className="relative h-[192px] overflow-hidden bg-gradient-to-b from-white via-white/80 to-[#2D4560]">
              <div className="absolute inset-0">
                <div className="relative w-full h-full">
                  <Image
                    ...
                    width={329}
                    height={202}
                    className="w-[329px] h-[202px] object-contain mx-auto group-hover:scale-105 transition-transform duration-700"
                  />
                </div>
              </div>
              <div className="absolute bottom-6 left-6 bg-[#4DB9DB] px-4 py-2 rounded-2xl flex items-center gap-2 shadow-lg z-10">
                <img src="/assets/Iconsf.png" alt="Standard" className="w-4 h-4 object-contain" />
            ...
            <div className="p-6 md:p-10 flex-1 flex flex-col">
              ...
              <p className="text-[#0A254099] mb-8 leading-relaxed font-medium font-serif">
              ...
              <ul className="space-y-4 mb-10">
                {["Domestic Scheduling", "Reliable Matching", "Verified water providers", "Predictable Pricing"].map((item) => (
                  <li key={item} className="flex items-center gap-3 text-[#0A2540BF] font-medium text-sm">
                    <img src="/assets/Iconsh.png" alt="check" className="w-5 h-5 object-contain" />
                    {item}
                  </li>
                ))}
              </ul>
              
              <button className="mt-auto w-full py-4 px-8 rounded-2xl border-2 border-[#1FAFBE] text-[#1FAFBE] bg-[#1FAFBE1A] font-black uppercase tracking-wider text-sm transition-all duration-300 font-manrope">
                Schedule Now
              </button>
            </div>
          </motion.div>
          ...
          >
              ...
              <div className="absolute inset-0">
                <div className="relative w-full h-full">
                  <Image
                    ...
                    width={497}
                    height={192}
                    className="w-[497px] h-[192px] object-cover mx-auto group-hover:scale-105 transition-transform duration-700"
                  />
                </div>
              </div>
            ...
            <div className="p-6 md:p-10 flex-1 flex flex-col text-white">
              <div className="flex items-center gap-3 mb-3 md:mb-4">
                <img src="/assets/Iconsg.png" alt="Urgent" className="w-5 h-5 md:w-6 md:h-6 object-contain" />
              ...
              <ul className="space-y-4 mb-10">
                {["Priority Dispatching", "Live Tanker Tracking", "Instant checkout", "Guaranteed fresh water"].map((item) => (
                  <li key={item} className="flex items-center gap-3 text-white/90 font-medium text-sm">
                    <img src="/assets/IconsI.png" alt="check" className="w-5 h-5 object-contain" />
                    {item}
                  </li>
                ))}
              </ul>
              
              <button className="mt-auto w-full py-4 px-8 rounded-2xl bg-yellow-400 text-[#0A2540] font-black uppercase tracking-wider text-sm hover:bg-white hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 shadow-[0_8px_25px_rgba(0,0,0,0.15)]">
                Order Urgent Now
              </button>
            </div>
          </motion.div>
